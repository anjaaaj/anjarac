...
\begin{figure} [!ht]
    ...
    \label{fig:sagrada}
    \includegraphics[scale=0.4]{sagrada.png}
\end{figure}
% Tu vstavite sliko
...
\begin{table}
  ...
  \begin{tabular}{lcccccc} \toprule
      ...
      red & 1 & 2 & 3 & 4 & 5 & 6 \\ 
      število kvadratov & 1 & 0 & 1 & 880 & 275305224 & !! \\ \bottom 
  \end{tabular}
\end{table}
...
leta 1693, glej \cite{bessy}, in jih je moč najti v knjigi \cite{berlek}
