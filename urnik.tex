...
omejitve so bile kršene ter kolikokrat se kršitev pojavi. S $n$ označimo število
kršitev omejitve $n$, z ?? pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
??
...
spremembo (npr. zamenjava $\text{srečanja}_i$ in $\text{srečanja}_j$) in sedaj shranimo v
